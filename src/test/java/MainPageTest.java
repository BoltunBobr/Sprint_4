...
public class MainPageTest {
    ...
    public MainPageTest(int numberOfAccordionItem, String expectedHeaderText, String expectedItemText) {
        numberOfAccordion = numberOfAccordionItem;
    ...
    public void checkAccordion() {
        ...
        if (mainPage.isAccordionItemOpen(numberOfAccordion)) {
            MatcherAssert.assertThat("Проблема с текстом в заголовке " + numberOfAccordion,
                    expectedHeaderText, equalTo(mainPage.getTextHeaderAccordion(numberOfAccordion)));
            MatcherAssert.assertThat("Проблема с текстом в теле " + numberOfAccordion,
                    expectedItemText, equalTo(mainPage.getTextItemAccordion(numberOfAccordion)));
        }
        else{
